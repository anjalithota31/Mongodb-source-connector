...
package com.mongodb.kafka.connect.source.notification;
  ...
  private String buildEmailBody(
    ...
    return format(
        "MongoDB Source Connector Connectivity Alert"
            ...
            + "--------------------------------------------------\n"
            + "• Connector task has been stopped.\n"
            + "• Check logs for detailed error information.\n"
            + "• Connector will need to be restarted manually.\n"
            + "\n"
            + "Recommended Checks\n"
            + "--------------------------------------------------\n"
            + "• Verify MongoDB cluster health and connectivity.\n"
            + "• Check if MongoDB is running and the connection.uri config is correct.\n"
            + "• Verify network connectivity and firewall rules.\n"
            + "• Check MongoDB authentication credentials.\n"
            + "• Review MongoDB change stream configuration.\n"
            + "\n"
