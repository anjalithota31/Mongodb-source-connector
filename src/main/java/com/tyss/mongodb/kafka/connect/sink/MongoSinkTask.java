...
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkConfig.PROVIDER_CONFIG;
...
import static com.tyss.mongodb.kafka.connect.util.VisibleForTesting.AccessModifier.PRIVATE;
