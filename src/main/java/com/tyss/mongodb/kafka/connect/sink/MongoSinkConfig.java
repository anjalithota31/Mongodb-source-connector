...
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkTask.LOGGER;
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkTopicConfig.TOPIC_OVERRIDE_PREFIX;
import static com.tyss.mongodb.kafka.connect.sink.SinkConfigSoftValidator.logIncompatibleProperties;
import static com.tyss.mongodb.kafka.connect.sink.SinkConfigSoftValidator.logObsoleteProperties;
...
import com.tyss.mongodb.kafka.connect.CustomMongoSinkConnector;
...
public class MongoSinkConfig extends AbstractConfig {
  ...
  public static final String TOPICS_CONFIG = CustomMongoSinkConnector.TOPICS_CONFIG;
