...
public class DocumentIdAdder extends PostProcessor {
  ...
  public DocumentIdAdder(final MongoSinkTopicConfig config) {
    ...
    this.overwriteExistingIdValues =
        config.getBoolean(DOCUMENT_ID_STRATEGY_OVERWRITE_EXISTING_CONFIG);
  }
   ...
   * @return true if the doc doesn't already contain the _id field or its configured to overwrite
   *     existing _id values.
   */
