 ...
 */
package com.tyss.mongodb.kafka.connect;

import static com.tyss.mongodb.kafka.connect.mongodb.ChangeStreamOperations.concat;
import static com.tyss.mongodb.kafka.connect.mongodb.ChangeStreamOperations.createDropCollection;
import static com.tyss.mongodb.kafka.connect.mongodb.ChangeStreamOperations.createInserts;
...
import static com.tyss.mongodb.kafka.connect.source.MongoSourceConfig.OUTPUT_SCHEMA_KEY_CONFIG;
import static com.tyss.mongodb.kafka.connect.source.MongoSourceConfig.OUTPUT_SCHEMA_VALUE_CONFIG;
import static com.tyss.mongodb.kafka.connect.source.MongoSourceConfig.PIPELINE_CONFIG;
import static com.tyss.mongodb.kafka.connect.util.jmx.internal.MBeanServerUtils.getMBeanAttributes;
import static com.tyss.mongodb.kafka.connect.util.jmx.internal.MBeanServerUtils.getMBeanDescriptionFor;
...
import com.tyss.mongodb.kafka.connect.log.LogCapture;
import com.tyss.mongodb.kafka.connect.mongodb.MongoKafkaTestCase;
import com.tyss.mongodb.kafka.connect.source.MongoSourceConfig;
...
import com.tyss.mongodb.kafka.connect.source.MongoSourceTask;
