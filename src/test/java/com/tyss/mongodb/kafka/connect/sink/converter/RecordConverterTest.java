  ...
  static void initializeTestData() {
    ...
    objectSchema =
        SchemaBuilder.struct()
            ...
            .field(
                "mySubDoc2", SchemaBuilder.map(Schema.STRING_SCHEMA, Schema.INT32_SCHEMA).build())
            .field(
                "mySubDoc3",
                SchemaBuilder.map(
            ...
            .field(
                ...
                SchemaBuilder.map(
                        Schema.STRING_SCHEMA,
                        SchemaBuilder.array(SchemaBuilder.array(Schema.INT32_SCHEMA).build())
                            .build())
                    .build())
            .field(
                "mySubDoc5",
    ...
    objectStruct =
        new Struct(objectSchema)
            ...
            .put(
                "myDate",
                java.util.Date.from(
                    ZonedDateTime.of(LocalDate.of(2017, 3, 17), LocalTime.MIDNIGHT, ZoneOffset.UTC)
                        .toInstant()))
            .put(
                "myTimestamp",
                java.util.Date.from(
            ...
            .put(
                "myTime",
                java.util.Date.from(
                    ZonedDateTime.of(LocalDate.of(2000, 1, 1), LocalTime.NOON, ZoneOffset.UTC)
                        .toInstant()))
            .put("myDecimal", new BigDecimal("12345.6789"));

    HashMap<Object, Object> structMap =
