...
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkTask.nopErrorReporter;
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkTopicConfig.ERRORS_TOLERANCE_CONFIG;
import static com.tyss.mongodb.kafka.connect.sink.MongoSinkTopicConfig.MAX_BATCH_SIZE_CONFIG;
  ...
  void testMongoSinkRecordProcessorSortsByTopic() {
    ...
    List<List<MongoProcessedSinkRecordData>> processedData =
        MongoSinkRecordProcessor.orderedGroupByTopicAndNamespace(
            sinkRecords, sinkConfig, nopErrorReporter());
    ...
    assertAll(
        ...
        () -> {
          List<List<MongoProcessedSinkRecordData>> processedData =
              MongoSinkRecordProcessor.orderedGroupByTopicAndNamespace(
                  sinkRecords,
                  createSinkConfig(ERRORS_TOLERANCE_CONFIG, "all"),
                  nopErrorReporter());
        ...
        () ->
            assertThrows(
                ...
                () ->
                    MongoSinkRecordProcessor.orderedGroupByTopicAndNamespace(
                        sinkRecords, createSinkConfig(), nopErrorReporter())));
  }
